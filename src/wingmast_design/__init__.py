"""wingmast-design: structural design of unidirectional CFRP wingsails.

See docs/plan.md for the phased development plan and docs/glossary.md
for terminology.

The single source of truth for design parameters is
`wingmast_design.scenario.DesignParameters` — use `small_scenario()` to
...
def main() -> None:
    print("wingmast-design — run examples with `just example 01_wing_solid` (see docs/plan.md).")
